...
|8. |termín v KOSu |xref:printing#[Tisk: Základy] |3

|9. |termín v KOSu |xref:bridges#[Tisk: Mosty] |3

|10. |termín v KOSu |xref:supports#[Tisk: Podpory] |3

|11. |termín v KOSu |xref:multicolor#[Tisk: Vícebarevný tisk] |3

|12. |zrušeno |Tisk - co si přejete vyzkoušet ohledně semestrální práce |0
