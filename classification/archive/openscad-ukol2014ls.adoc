...
<note tip>Naše automatické testy používají plný render (v apliakci zkratka F6). Netestujte váš kód pouze s F5. Pozor také na modifikátor % - v režimu plného renderu se takto prefixovaný kód neobjeví.</note>

====== Náhled ======

{{:classification:openscad-ukol-ls1415:nahled_1.png?0x250|}}
{{:classification:openscad-ukol-ls1415:nahled_2.png?0x250|}}
{{:classification:openscad-ukol-ls1415:nahled_3.png?0x250|}}

===== Podstava =====

{{:classification:openscad-ukol-ls1415:podstava.png|}}

====== Vnější rozměry ======

{{:classification:openscad-ukol-ls1415:bokorys.png?0x368|}}
{{:classification:openscad-ukol-ls1415:vrsek.png?0x368|}}
...
{{:classification:openscad-ukol-ls1415:bokorys-rez.png?0x368|}}
{{:classification:openscad-ukol-ls1415:vrsek-rez.png?0x368|}}
