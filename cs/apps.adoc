...
* https://www.orcaslicer.com/download/[OrcaSlicer]
...
a kromě OrcaSlieru, který lze nainstalovat přes flatpak).
...
`# dnf install openscad admesh-devel`
* netfabb Basic a KISSlicer naleznete v repozitáři
http://rpmfusion.org/[RPM Fusion], jako `netfabb-basic`, respektive
`kisslicer`
* Po stažení flatpaku s OrcaSlicerem: `$ flatpak install .../OrcaSlicer-Linux-flatpak_...flatpak`
...
netfabbu]
netfabbu]
* https://www.orcaslicer.com/download/[Stažení OrcaSliceru]
