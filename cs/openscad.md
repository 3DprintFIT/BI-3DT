...
-   [manuál v angličtině](http://en.wikibooks.org/wiki/OpenSCAD_User_Manual) -- velmi vyčerpávající, použijte jako referenci
...
-   **podobné C/C++** -- středníky, chlupaté závorky, komentáře
    ...
    -   **čísla** buď celá nebo desetinná -- ''1'', ''0'', ''-5'', ''5.3'', ''9.99998'', ''8/5''
...
-   ''cylinder(h,r1,r2,center);'' -- (komolý) kužel (''r1,r2'') nebo válec (''r'')
...
-   implicitní ''union()'' na výsledku
    ...
    -   proto existuje ''intersection_for()'' -- funguje stejně, jen s ''intersection()''
...
-   můžete je mít v jiných souborech a použít ''include `<f.scad>`;'' nebo ''use `<f.scad>`;''
    -   ''use'' umožňuje použít moduly,  \* ''include'' rovnou vykreslí, co se v souboru vykreslí
...
-   ''$fn'', ''$fa'' a ''$fs'' nastavuje rozlišení, viz [manuál](http://en.wikibooks.org/wiki/OpenSCAD_User_Manual/The_OpenSCAD_Language#.24fa.2C_.24fs_and_.24fn)
...
-   [molekula ze cvičení](https///cubehero.com/physibles/hroncok/Molecule) interně zde [](tutorials/openscad/molecule)
