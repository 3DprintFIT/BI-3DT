...
IMPORTANT: Pro dnešní cvičení si stáhněte konfigurační bundle pro OrcaSlicer. Pokud ho máte stažený z minulých cvičení, nemusíte ho znovu importovat. Odkazy najdete v xref:printing#config-file[sekci o konfiguraci v návodu k tisku].
