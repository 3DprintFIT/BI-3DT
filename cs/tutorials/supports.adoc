...
IMPORTANT: Pro dnešní cvičení si stáhněte konfigurační bundle pro OrcaSlicer. Pokud ho máte stažený z minulých cvičení, stáhněte si aktuální verzi a znovu ho importujte. Odkazy najdete v xref:printing#config-file[sekci o konfiguraci v návodu k tisku].
