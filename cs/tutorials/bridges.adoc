...
ale body se udělují pouze za mosty s *výchozími rozměry* (12,5 mm široký, 138 mm dlouhý).
Výchozí most je nutné na tiskovou desku umístit *diagonálně* (otočený o 45°), aby se vešel.
