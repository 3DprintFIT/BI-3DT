...
3. Klikněte pravým tlačítkem na ikonu + a vyberte `Add Pause`
4. Vyexportujte GCode a model vytiskněte.
5. Tiskarna se zastaví na požadované vyšce, vyměntě filament manualně a pokračujte v tisku.
