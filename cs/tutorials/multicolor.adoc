...
IMPORTANT: Pro dnešní cvičení si stáhněte konfigurační bundle pro OrcaSlicer. Odkaz najdete v xref:printing#config-file[sekci o konfiguraci v návodu k tisku].
