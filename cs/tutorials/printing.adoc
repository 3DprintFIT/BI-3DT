...
Adresa tiskárny Hybrix:: http://printer-XX.3dprintlab.in.fit.cvut.cz/
Adresa tiskárny Voron 0.2:: http://voron-02-XX.3dprintlab.in.fit.cvut.cz/
...
IMPORTANT: Cvičící vám na cvičení řeknou, kterou tiskárnu použijete.
...
==== Pro tiskárnu Voron 0.2

Zkontrolujte, že načtené a zvolené nastavení pro tiskárnu je pojmenované *Voron 0.2* a materiál *Generic PETG*.

==== Pro tiskárnu Hybrix

Zkontrolujte, že načtené a zvolené nastavení pro tiskárnu je pojmenované *Hybrix* a materiál *PET*.

NOTE: Pokud při tisku narazíte na jakýkoliv problém, konzultujte se cvičícím, nebo zkuste problém najít v xref:../troubleshooting/index#[troubleshootingu].
