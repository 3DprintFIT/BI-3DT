...
.https://www.youtube.com/watch?v=C51JWbLgJu0[Záznam z online cvičení z roku 2020 (pozor, dnes používáme jiný slicer)].
...
Zip soubor načtěte pomocí __File → Import → Import Configs__. Úspěšné načtení configů poznáte podle nových položek vlevo nahoře. Měli byste vidět v nabídce tiskáren FIT Voron 0.2 a FIT Hybrix.
...
NOTE: OrcaSlicer již podporuje Češtinu, ale ne všechny překlady jsou přesné nebo dávají smysl, proto v tomto textu používáme anglickou verzi. Pokud i přes to chcete použít češtinu, je možné v nastavení programu změnit jazyk.
