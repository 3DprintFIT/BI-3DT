...
Hybrix printer address:: http://printer-XX.3dprintlab.in.fit.cvut.cz/
Voron 0.2 printer address:: http://voron-02-XX.3dprintlab.in.fit.cvut.cz/
...
Download both configuration files for the printers we use in printing exercises:
...
IMPORTANT: The instructors will tell you at the exercise which printer you will use.
...
==== For Voron 0.2 Printer

Check that the loaded and selected printer setting is named *Voron 0.2* and material *Generic PETG*.

==== For Hybrix Printer

Check that the loaded and selected printer setting is named *Hybrix* and material *PET*.

NOTE: If you encounter any problem during printing, consult with the instructor, or try to find the problem in xref:../troubleshooting/index#[troubleshooting].
