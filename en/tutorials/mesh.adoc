...
* `cat` and `hexdump` for those with great imagination 😎
...
* link:../stls/mesh/cube_bad.stl[cube_bad.stl] – cube from the video with
errors
* link:../stls/mesh/cube_correct.stl[cube_correct.stl] – cube from the video
without errors
...
* link:../stls/mesh/tajmahal.stl[tajmahal.stl] – ungraded task for
