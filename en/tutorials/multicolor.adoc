...
3. Right-click on the + icon and select `Add Pause`
4. Export the GCode and print the model.
5. The printer will stop at desire height change the filament manually and resume the print.
